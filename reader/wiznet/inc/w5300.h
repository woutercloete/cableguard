 ...
 *  Mode register. 
 */
#define MR_             (__DEF_IINCHIP_MAP_BASE__)
#define MR             (MR_ + 1)
 ...
 */
#define RCR_            (COMMON_REG_BASE + 0x1E)
#define RCR             (RCR_ + 1)
 ...
 */
#define Sn_MR_(n)       (SOCKET_REG_BASE + n * SOCKET_REG_SIZE + 0x00)
#define Sn_MR(n)        (Sn_MR_(n)+1)

/**
 *  SOCKETn command register
 */                        
#define Sn_CR_(n)       (SOCKET_REG_BASE + n * SOCKET_REG_SIZE + 0x02)
#define Sn_CR(n)        (Sn_CR_(n) + 1)   

/**
 *  SOCKETn interrupt mask register
 */
#define Sn_IMR_(n)      (SOCKET_REG_BASE + n * SOCKET_REG_SIZE + 0x04)
#define Sn_IMR(n)       (Sn_IMR_(n)+1)

/**
 *  SOCKETn interrupt register
 */
#define Sn_IR_(n)       (SOCKET_REG_BASE + n * SOCKET_REG_SIZE + 0x06)
#define Sn_IR(n)        (Sn_IR_(n)+1)

/**
 *  SOCKETn status register
 */
#define Sn_SSR_(n)      (SOCKET_REG_BASE + n * SOCKET_REG_SIZE + 0x08)
#define Sn_SSR(n)       (Sn_SSR_(n)+1)
 ...
 */
#define Sn_PROTOR_(ch) 		(SOCKET_REG_BASE + ch * SOCKET_REG_SIZE + 0x1A)
#define Sn_PROTOR(ch)     (Sn_PROTOR_(ch)+1)
 ...
 *  Basic I/O Function
 */
uint8 IINCHIP_READ(uint16 addr);								// Read Function
void IINCHIP_WRITE(uint16 addr,uint8 data);	   	// Write Function
