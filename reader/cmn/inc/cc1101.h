...
class CC1101 {
  private:
    //SPI spi; //TODO hook in uour own SPI class
    ...
    u08 isrCnt;
  public:
    void cmdStrobe(u08 cmd);
    volatile bool tagreceived;
    u08 readReg(u08 regAddr, u08 regType);
    Tfifo<C1101::sRadioPacket> rxFifo;
    Tfifo<C1101::sRadioPacket> txFifo;
    u08 channel;
    u08 syncWord[2];
    u08 devAddress;
    ...
    void reset(void);
    void powerdown();
    bool sendData(u08 *data, u08 len);
